        ...
        for (Attributes attribute : this.attributes) {
            if (attribute.getStructuralDir() != null && attribute.getText() != null) {
                if (Objects.equals(attribute.getStructuralDir(), "*ngFor")) {
                    ...
                    stringBuilder.append("<h3>No ").append(attribute.getText().substring(attribute.getText().indexOf("of ") + 3, attribute.getText().length() - 1)).append(" available<br>Add ").append(attribute.getText().substring(attribute.getText().indexOf("of ") + 3, attribute.getText().length() - 1)).append(" to see them listed here</h3>`;\n").append("return;\n}\n");
