...
public class angularParser extends Parser {
	...
	public static final int
		...
		AND=54, EQUAL_EQUAL=55, NOT_EQUAL=56, STYLES=57, TEMPLATE=58, CONFIRM=59, 
		IDENTIFIER=60, NUMBER=61, STRING=62, WHITESPACE=63, COMMENT=64, BLOCK_COMMENT=65, 
		BACKTICK2=66, COLON2=67, COMMA2=68, OPEN_SQUARE=69, CLOSE_SQUARE=70, DOT2=71, 
		PX=72, EM=73, REM=74, SEMICOLON2=75, LBRACE2=76, RBRACE2=77, PERCENT=78, 
		WS2=79, LINE_COMMENT2=80, BLOCK_COMMENT2=81, ID=82, BACKTICK=83, LINE_COMMENT_HTML=84, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"AND", "EQUAL_EQUAL", "NOT_EQUAL", "STYLES", "TEMPLATE", "CONFIRM", "IDENTIFIER", 
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8070450532252254210L) != 0)) {
				{
				{
				setState(386);
				functionBody();
